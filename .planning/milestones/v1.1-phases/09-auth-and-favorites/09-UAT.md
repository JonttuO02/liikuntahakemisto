...
[re-testing after fixes: NavBar onAuthStateChange, HeartButton supabase scope bug, debug log cleanup]
...
result: pending
fix_applied: "NavBar käyttää nyt onAuthStateChange-kuuntelijaa — päivittyy ilman router.refresh(). NavBarissa on tekstiselitteet kaikissa napeissa (Kirjaudu, Kirjaudu ulos, Haku, Suosikit)."
...
result: pending
fix_applied: "handleSignOut tekee optimistisen setClientEmail(null) ennen supabase signOut() -kutsua."
...
result: pending
fix_applied: "HeartButton: supabase-muuttuja oli määritelty vain useEffect-sulkeumassa, ei toggle()-funktiossa. Lisätty createBrowserSupabase() toggle():n alkuun."
...
result: pending
fix_applied: "Sama HeartButton scope-korjaus kuin yllä."
...
result: pending
note: "Etusivu käyttää omaa toggleSuosikki-funktiota (ei HeartButton-komponenttia) — supabase-scope oli jo kunnossa."
...
result: pending
fix_applied: "HeartButton scope-korjaus."
...
result: pending
note: Testattavissa kun sydännappi-korjaus on vahvistettu toimivaksi.
