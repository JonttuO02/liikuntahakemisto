...
- [ ] 51-07-PLAN.md — Gap closure (CR-01, branding path): overlay live state.hinnasto/aukioloajat/yhteystiedot onto buildBrandingPreview's output in LivePreviewContext so AI-website-analysis-onboarded venues see live pricing/hours/contact edits, not frozen scraped/null data (LIVEPREV-01/02/03/04)
...
| 51. Live-esikatselu velhossa | v2.2 | 6/6 | Complete   | 2026-06-18 |
