...
- [x] 55-02-PLAN.md — Persistence routes: save-step 'laji' ALLOWED_FIELDS + bounded validator; submit conditional-spread write (no null-overwrite); new submit/save-step route tests (D-02, D-04)
