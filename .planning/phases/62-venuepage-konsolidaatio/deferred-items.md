...
(pre-existing issues unrelated to the files each plan modifies), per the SCOPE
...
- **Action:** Not fixed. Flagging for a future Phase 61 cleanup pass or a dedicated lint-debt task. Same error also independently flagged by Plan 01 above — single fix will resolve both.
